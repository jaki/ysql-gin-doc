...
regular value.  However, it's very cramped, and I don't think there's any space
for new value types that are in the fringes.  Therefore, the second solution of
reusing the existing null value types seems like the only option.
