...
\begin{oparts}
\item
  $\geq$ \textinline{H\x80\x00\x00\x01Sab\x00\x00}
\item
  $<$ \textinline{H\x80\x00\x00\x01Sac\x00\x00}
\end{oparts}
...
\begin{oparts}
\item
  $>$ \textinline{H\x80\x00\x00\x02a\x9b\x99\xff\xff}
\item
  $\leq$ \textinline{H\x80\x00\x00\x02a\x9b\x9a\xff\xff}
\end{oparts}
