...
\item
  \textbf{getkey}:
  given index $I$, get list of tuples $T = \braces{(ik, pk) \in I : f(ik)}$ for
  $f$ a simple predicate like
  \begin{oparts}
  \item
    $ik < c$
  \item
...
\item
  \textbf{and}:
  given list of tuples $T_1$, $T_2$, get $T = T_1 \cap T_2$
\item
  \textbf{or}:
  given list of tuples $T_1$, $T_2$, get $T = T_1 \cup T_2$
\item
  \textbf{recheck}:
  given list of tuples $T_1$, get list of tuples $T = \braces{(ik, pk) \in T_1
  : g(pk)}$ for $g$ any predicate like
  \begin{oparts}
  \item
